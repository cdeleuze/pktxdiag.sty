...
entities.  Multiple (more than two) entities can be used.
...
\item[\texttt{hdlc}] specifies the list of label for short frames in
  the HDLC protocol. These are RR, RNR, REJ, SREJ, SABM, DISC, UA.
...
a timer canceling frame correct in a vertical diagram may be incorrect
in a horizontal diagram.
...
\begin{verbatim}
\documentclass[convert={density=100,outext=.png},multi={pktxdiag}]{standalone}
\usepackage{pktxdiag}
\begin{document}
