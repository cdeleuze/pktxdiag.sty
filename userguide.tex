...
TODO cancel before any timer was run gives as latex error
...
The default setting (left picture) is probably what you want...
...
TODO other setting \texttt{timers/on arrow}
...
Command \texttt{XwaitY} is the generalized synchronize command:
\texttt{AwaitB} is a shorthand for \verb+XwaitY{A}{B}+.
...
show the decoupling of the drawing and the protocol logic (not
completely done so far)
