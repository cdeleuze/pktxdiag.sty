...
\texttt{timer2 offset}.  This can be set for only A or B with
\texttt{A timer offset}, \texttt{BB timer2 offset} etc.
...
Missing features available in vertical diagrams include : late frames,
laters, states and actions.
