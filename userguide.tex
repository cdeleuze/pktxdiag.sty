...
Ensure the file \texttt{pktxdiag.sty} is in \LaTeX's load path.  A
quick and easy way is to copy it in the directory from which you run
the compilation commands.

% or standard, or TEXINPUTS
