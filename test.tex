...
\subsubsection*{Explicit label styles}

\def\testframelabelstyle{
  \AB{toto}
  \BA[id=1, label style=orange]{titi}
  \AB{toto again}
  \AB[id=1,label style={font=\scshape}]{tutu}
  \BA[label style={sloped=false,draw,fill=orange!20,opacity=0.75}]{tata}
  \AB{toutou}}

\begin{figure}[H]
\centering\subfloat[explicit]{\begin{pktxdiag}
\testframelabelstyle
\end{pktxdiag}}\hfill
\centering\subfloat[explicit and env label style]{
\begin{pktxdiag}[label style={font=\it}]
  \testframelabelstyle
\end{pktxdiag}}\hfill
\centering\subfloat[explicit,env, and flow label style]{
\begin{pktxdiag}[label style={font=\it}]
  \derivestyle{ls1}{labeldefault}{blue,font=\rmfamily}
