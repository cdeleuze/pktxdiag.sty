...
\subsubsection*{Timers: timer label on arrow}
...
\subsubsection*{More timers, timer offsets}
...
\subsubsection*{Flows and filtering}
...
\subsubsection*{Filtering, flow styles}
...
\subsubsection*{Changing global styles}
...
\subsubsection*{Explicit, env, and flow frame styles}

\def\testframestyle{
  \AB{env-only}
  \BA[id=1, style=orange]{flow1, orange}
  \AB{env-only}
  \AB[id=1,style={dashed}]{flow1, dashed}
...
\subsubsection*{Explicit, env, and flow label styles}

\def\testframelabelstyle{
  \AB{env-only}
  \BA[id=1, label style=orange]{flow1, orange}
  \AB{env-only}
  \AB[id=1,label style={font=\scshape}]{flow1, scshape}
...
\subsubsection*{Multi line labels and entity names}
...
\subsubsection*{The \texttt{pause} env option}
...
\subsubsection*{XwaitY for multiple entities}
...
\subsubsection*{timers for multiple entities}
